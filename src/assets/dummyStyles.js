// assets/dummyStyles.js - Styles pour les pages de rendez-vous et les cartes
...
export const badgeStyles = {
  // Badge de paiement avec différents statuts
  paymentBadge: {
  ...
  // Badge de statut avec différents états
  statusBadge: {
...
// Aide pour les tailles d'icônes
...
export const bannerStyles = {
  // Styles du conteneur de bannière
  ...
  featureItem: "flex items-center mb-3 justify-center lg:justify-start bg-linear-to-br from-green-500 to-green-200 backdrop-blur-sm p-3 rounded-full shadow-sm border",
  featureIcon: "w-5 h-5 text-white mr-3",
  featureText: "text-gray-700 font-medium",
  
  // Couleurs des bordures des fonctionnalités
...
export const commonStyles = {
  // Styles d'utilitaires communs réutilisables dans tous les composants
...
// dummyStyles.js - Styles CSS centralisés pour tous les composants
...
export const certificationStyles = {
  ...
  // Images clés d'animation et classe (à ajouter via la balise style)
  animationStyles: `
...
export const doctorsPageStyles = {
  ...
  backgroundShape2:
    "absolute -bottom-40 -left-32 w-72 h-72 sm:w-96 sm:h-96 bg-teal-200 rounded-full mix-blend-multiply filter blur-2xl opacity-30 animate-pulse",
  wrapper: "max-w-7xl mx-auto relative z-10 font-serif",
  headerContainer: "text-center mb-8 sm:mb-10 animate-fade-in",
  headerTitle:
    "text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-emerald-700 to-teal-600 bg-clip-text text-transparent mb-3 tracking-tight",
  ...
  retryButton: "px-4 py-2 rounded-full bg-emerald-600 text-white hover:bg-emerald-700 transition",
  skeletonGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8",
  skeletonCard:
    "animate-pulse bg-white/80 backdrop-blur-md rounded-3xl p-4 sm:p-5 md:p-6 text-center",
  skeletonImage:
    "relative mx-auto mb-4 w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 bg-emerald-100 rounded-full",
  ...
  doctorsGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8 transition-all duration-300",
  doctorCard:
    "bg-white/80 backdrop-blur-md rounded-3xl p-4 sm:p-5 md:p-6 text-center transition-all duration-300 hover:shadow-xl animate-fade-in-up group",
  ...
  doctorInfo: "",
  doctorName:
    "text-base sm:text-lg font-bold text-emerald-900 mb-1 whitespace-nowrap overflow-hidden text-ellipsis",
  doctorSpecialization: "text-sm text-emerald-600 font-medium mb-3",
  experienceBadge:
    "inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium mb-4 bg-emerald-50 border border-emerald-300 shadow-sm text-emerald-800",
  experienceIcon: "w-4 h-4 text-emerald-600",
  bookButton:
    "w-full inline-flex items-center justify-center gap-2 py-2 rounded-full font-medium transition-all duration-300 text-sm bg-gradient-to-r from-emerald-400 to-teal-500 text-white hover:shadow-lg hover:scale-105",
  notAvailableButton:
  ...
  viewMoreContainer: "flex justify-center mt-8 sm:mt-10",
  viewMoreButton:
    "flex items-center cursor-pointer gap-2 px-5 py-2.5 bg-gradient-to-r from-emerald-400 to-teal-500 text-white rounded-full text-md font-semibold shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105",
...
export const footerStyles = {
  ...
  // Images clés d'animation pour les icônes flottantes (à ajouter via la balise style)
  animationStyles: `
    @keyframes float {
      0%, 100% {
...
// Styles pour la section des médecins à la page d'accueil
...
export const homeDoctorsStyles = {
  ...
  // CSS personnalisé
  customCSS: `
    /* maintenir l'apparence d'ombre cohérente */
    .shadow-md { box-shadow: 0 6px 18px rgba(14, 30, 37, 0.06); }
    .shadow-2xl { box-shadow: 0 18px 50px rgba(14, 30, 37, 0.12); }

    /* optionnel: réduire légèrement l'espacement sur les très petits appareils pour la compacité */
...
export const loginPageStyles = {
  ...
  // Champs d'entrée
  input: "w-full px-5  mb-6   py-3 rounded-full border border-green-300 bg-white/80",
  
  // Bouton de soumission
  submitButton: "w-full py-3 bg-linear-to-r from-emerald-400 to-green-600 text-white font-semibold rounded-full",
  
  // Styles de notification (conservés dans le composant car ils sont en ligne)
  // Ceux-ci restent dans le composant car ce sont des objets JS, pas des classes CSS
  
  // Ajustements réactifs
  responsiveCard: "p-8 w-[90%] max-w-md"
};

// Styles de notification (notification toast)
...
export const navbarStyles = {
  ...
  // Styles d'animation (à ajouter via la balise style)
  animationStyles: `
...
export const doctorDetailStyles = {
  ...
  mainContent: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-all duration-700",
  ...
  // ─── Header ───────────────────────────────────────────────────────────────
  headerContainer: "sticky top-16 w-full bg-white/80 backdrop-blur-lg border-b border-emerald-100 z-40",
  ...
  avatarImage: "relative w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full object-cover border-4 sm:border-8 border-white shadow-2xl z-10 transition-transform duration-300",
  ...
  formInput: "p-3 rounded-full border border-emerald-200 w-full focus:outline-none focus:ring-2 focus:ring-emerald-300",
  emailInput: "p-3 rounded-full border border-emerald-200 w-full md:col-span-2 focus:outline-none focus:ring-2 focus:ring-emerald-300",
  formSelect: "p-3 rounded-full border border-emerald-200 w-full focus:outline-none focus:ring-2 focus:ring-emerald-300 bg-white",
  ...
  timeSlotButton: "min-w-[140px] p-2 rounded-full border-2 cursor-pointer transition-all",
  ...
  bookingButtonEnabled: "bg-gradient-to-r from-emerald-500 to-green-500 text-white",
...
export const navbarStylesDr = {
  ...
  logoutButtonDesktop: "hidden lg:flex items-center gap-2 px-4 py-2 rounded-full text-emerald-500  bg-white  border border-emerald-200 shadow-sm text-sm font-semibold transition-all duration-200 transform hover:scale-105 hover:-translate-y-0.5",
...
export const listPageStyles = {
  // Main container
  pageContainer: "min-h-screen pt-20 md:pt-25 lg:pt-40 font-serif p-4 sm:p-6 bg-linear-to-br from-emerald-50 to-white",
  ...
  cardAvatar: "w-12 h-12 sm:w-14 sm:h-14 rounded-full overflow-hidden bg-emerald-50 border border-emerald-100 flex items-center justify-center flex-shrink-0",
  cardAvatarImage: "w-full h-full object-cover",
  cardAvatarFallback: "text-emerald-700 font-bold text-lg",
...
export const dashboardStyles = {
  // Main container
  pageContainer: "min-h-screen font-serif pt-16 lg:pt-29 md:pt-15 p-4 sm:p-6 bg-linear-to-br from-emerald-50 to-white",
  
  // Content wrapper
  contentWrapper: "max-w-7xl mx-auto mt-7",
  ...
  // Appointment card
  appointmentCard: "rounded-xl  bg-white shadow-sm border border-emerald-100 flex flex-col justify-between gap-4 hover:shadow-md transition self-start",
